...
#tried for the stars in the Pleiades but had no luck
# Proxima Centauri - not so good - I can't see the point
fig_4 = plt.figure()
plt.subplot(1, 1, 1, projection="3d")
constellation3d = plt.scatter(-0.472, -0.361, -1.151)
plt.title("Proxima Centauri - 3D Rendering")
plt.show()
